...
actor UserRegistration {
  ...
  public query func isUsernameTakenHello(username : Text) : async Bool {
  ...
  public func isCorrectPasswordHello(username : Text, password: Text) : async Text {
  ...
  public func registerUserHello(users : Text, password : Text) : async Bool {
  ...
  public func getCurrentUserHello() : async Text {
    return currentUser;
  };
  ...
  public func getPendingtodoHello() : async [Text] {
    switch (usersByUsername.get(currentUser)) {
      case (?user) {
  ...
  public func addinCompletedListHello(value : Text) : async () {
    switch (usersByUsername.get(currentUser)) {
      case (?user) {
  ...
  public func getCompletedtodoHello() : async [Text] {
    switch (usersByUsername.get(currentUser)) {
      case (?user) {
